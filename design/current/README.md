...
*All screenshots made again on 2026-09-24 with headless Chromium from the links above (seed 6), with active choosing, the adaptive fair-test size and the spread fast-forward (scope decisions 32–38 and 42). The ending and died-out shots were made again with the seventeen reveal animals and their facts (scope decisions 45 and 46).*
